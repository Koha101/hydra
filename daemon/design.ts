...
export async function startDesign(
  ...
  // Per-spawn banners (doSpawnSession) already announce each persona with its
  // role and session — the old aggregate mapping line would just repeat them.
  await safeSend(threadId, `_Waiting for questions..._`)
